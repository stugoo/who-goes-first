...
(0, _jquery2.default)(document).ready(function () {
    ...
    if ('serviceWorker' in navigator) {
        window.addEventListener('load', function () {
            navigator.serviceWorker.register('assets/js/index.js').then(function (registration) {
...
var decider = new _decider.Decider();

var pages = (0, _jquery2.default)('[data-page]');
...
function setRoutes() {
    ...
    router.on({
        'decision/:id': function decisionId(params) {
...
var responses = _interopRequireWildcard(_base);
...
var Decider = exports.Decider = function () {
    ...
    _createClass(Decider, [{
        ...
        key: 'show',
        value: function show() {
            (0, _jquery2.default)('[data-decision]').text(this.get());
            return 'yolo';
        }
    }]);
...
var BASE_RESPONSES = exports.BASE_RESPONSES = ['Oldest', 'Youngest', 'Lives closest', 'Farthest away', 'Last person to go to the bathroom', 'First person to say the word "flange" (random word)', 'You go first', 'The person To your left', 'The person to your right', 'The tallest', 'Shortest', 'The person with the longest name', 'Shortest name', 'Last person to eat', 'Person who got up the earliest', 'Went to bed latest', 'Who\'s favourite number is closest to 76', 'Last person to shave or deliberately remove any hair.', 'The loser of the last game', 'The winner if the last game', 'Last person to masturbate', 'Last person to have an orgasm', 'Last person to eat bread', 'Last person to take a drink', 'Last person who spoke whilst you read this out', 'Person with the weirdest face'];
